...
/* 
 * Java Collection : 객체를 수집해서 CRUD 할 수 있는 역할을 수행함
 * - List 계열 : Vector, ArrayList (Web), LinkedList  
 * - Map 계열 : Hashtable, Hasmap (Web), Properties
 * - Set 계열 : HasSet(Web), TreeSet
 * 
 * 
 * Vector 
 *  - 객체 유형의 데이터 저장 가능
...
public class VectorTest {
	public static void main(String[] args) {
		...
		// 초기용량 : 5 , 증가치 : 3 => 데이터가 차면 저장 영역을 3만큼 늘린다/
		// 기본 생성자일 경우 초기 용량 : 10, 증가치 : 10
		...
		v.add(Integer.valueOf(20)); // v.add(new Integer(20));
		...
		// Q. Float유형을 저장할 벡터 v3를 생성하고 Float객체 3개 저장하세요.
		...
		// Q. 확장 for루프를 이용해 v3에 저장된 값들의 합계를 구하세요
