...
public class HashtableTest {
	...
	public static void main(String[] args) {
		// jdk 1.4버전
		Hashtable h = new Hashtable(20,0.8f); // 초기용량: 20
		// 적재율(load factor):0.8(80 %) : 데이터 저장 용량의 80%가 차면 자동으로 저장 영역을 확장한다.
		h.put("하나",Integer.valueOf(1));
		h.put("둘","Two");
		h.put("빨강","Red");
		h.put("파랑", java.awt.Color.blue);
		//h.put("하나", "One"); key의 중복을 허용하지 않음, 덮어쓰기
		...
		// jdk 5.0 - Generic 사용 <Key값 유형, Value유형>
...
// --------------------------------------------
		...
		Enumeration<String> em =h2.keys();
		
		while(em.hasMoreElements()) {
			String key = em.nextElement();
			System.out.println(key+"key: "+h2.get(key));
		}
